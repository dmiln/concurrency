...
import examples.concurrency.Tester;
...
public class ListPerformance {
  ...
  static class ListTester extends examples.concurrency.Tester<List<Integer>> {
  ...
  public static void main(String[] args) {
    if(args.length > 0)
      examples.concurrency.Tester.defaultParams = TestParam.array(args);
    // Can only do these two tests on an array:
    examples.concurrency.Tester<List<Integer>> arrayTest =
      new examples.concurrency.Tester<List<Integer>>(null, tests.subList(1, 3)){
    ...
    arrayTest.timedTest();
    examples.concurrency.Tester.defaultParams= TestParam.array(
    ...
    examples.concurrency.Tester.fieldWidth = 12;
    examples.concurrency.Tester<LinkedList<Integer>> qTest =
