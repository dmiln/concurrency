...
public class RecoverCADState {
  ...
  public static void main(String[] args) throws Exception {
    ...
    examples.gui.List<Class<? extends Shape>> shapeTypes =
      (examples.gui.List<Class<? extends Shape>>)in.readObject();
    Line.deserializeStaticState(in);
    examples.gui.List<Shape> shapes = (List<Shape>)in.readObject();
